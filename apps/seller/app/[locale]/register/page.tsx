...
import SellerRegisterForm from '@root/components/seller/register/SellerRegisterForm'
import PendingStatusView from '@root/components/seller/register/PendingStatusView'
import RejectedStatusView from '@root/components/seller/register/RejectedStatusView'
import { getAuthRedirectUrl } from '@root/lib/auth-config'
...
export default async function SellerRegisterPage() {
  ...
  if (!user) {
    // Redirection vers le portail d'auth centralisé
    redirect(getAuthRedirectUrl('/login', `${process.env.NEXT_PUBLIC_SELLER_PORTAL_URL || 'https://seller.sharufa.com'}/register`))
  }
