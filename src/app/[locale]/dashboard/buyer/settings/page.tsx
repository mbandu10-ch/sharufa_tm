    ...
    <div className="space-y-10 max-w-7xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col gap-2">
         ...
         <h1 className="text-5xl font-black font-outfit text-primary tracking-tighter leading-none">
            Mon Compte <span className="text-blue-600 italic">Personnel</span>
         </h1>
         <p className="text-muted-foreground text-lg font-medium">Gérez vos informations de livraison et vos accès de sécurité.</p>
      </div>
      ...
      <Tabs defaultValue="profile" className="w-full space-y-10">
        ...
        <TabsContent value="notifications" className="animate-in fade-in slide-in-from-left-4 duration-500">
           <div className="bg-white p-12 rounded-[40px] border border-slate-100 shadow-sm text-center">
              <p className="text-muted-foreground font-medium italic">Le centre de notifications personnalisées sera bientôt disponible.</p>
           </div>
        </TabsContent>
      </Tabs>
    </div>
